...
Network Resnet50 {
	...
	Layer CONV2_1_Residual {
		Type: DSCONV
		Stride { X: 1, Y: 1 }		
		Dimensions { N: NumBatches, C: 256, R: 1, S: 1, Y: 56, X: 56 }
		Dataflow {
			TemporalMap(NTileSz,NTileSz) N;
			TemporalMap(CTileSz,CTileSz) C;
			SpatialMap(YTileSz,YTileSz) Y';
	...
	Layer CONV3_1_Residual {
		Type: DSCONV
		Stride { X: 1, Y: 1 }		
		Dimensions { N: NumBatches, C: 512, R: 1, S: 1, Y: 28, X: 28 }
		Dataflow {
			TemporalMap(NTileSz,NTileSz) N;
			TemporalMap(CTileSz,CTileSz) C;
			SpatialMap(YTileSz,YTileSz) Y';
	...
	Layer CONV4_1_Residual {
		Type: DSCONV
		Stride { X: 1, Y: 1 }		
		Dimensions { N: NumBatches, C: 1024, R: 1, S: 1, Y: 14, X: 14 }
		Dataflow {
			TemporalMap(NTileSz,NTileSz) N;
			TemporalMap(CTileSz,CTileSz) C;
			SpatialMap(YTileSz,YTileSz) Y';
	...
	Layer CONV5_1_Residual {
		Type: DSCONV
		Stride { X: 1, Y: 1 }		
		Dimensions { N: NumBatches, C: 2048, R: 1, S: 1, Y: 7, X: 7 }
		Dataflow {
			TemporalMap(NTileSz,NTileSz) N;
			TemporalMap(CTileSz,CTileSz) C;
			SpatialMap(YTileSz,YTileSz) Y';
